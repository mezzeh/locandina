...
(function (MachineStatus) {
    MachineStatus[MachineStatus["Off"] = 0] = "Off";
    MachineStatus[MachineStatus["Standby"] = 1] = "Standby";
    MachineStatus[MachineStatus["Brewing"] = 2] = "Brewing";
    MachineStatus[MachineStatus["Maintenance"] = 3] = "Maintenance";
...
class SmartCoffeMachine {
    ...
    getStato() { return this.status; }
    getWater() { return this.water_level; }
    getPod() { return this.pod_inserted; }
    read() {
...
function readyMachines(machines) {
...
function test(nomeTest, condizione) {
    if (condizione) {
...
function testEccezione(nomeTest, funzione) {
    try {
        funzione();
