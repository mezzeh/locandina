...
let a = "t1"
let b = "t2"
//scrivere una funziona applcabile a sort()
//let nuovo = arr.sort(compareTask())
//console.log(nuovo)

//gli sto passando comunque id e asc true;

//sort vuole due var comunque
...
function comparatoreTask(criterio = "id",ascendente = true)
{
    return function (a,b)
    {
        ...
        {
            case "id":
                //restituire quello che viene prima.
                ris = a.id.localeCompare(b.id)
                
            break;

            case "priorita":
                
                ris =  a.priorita - b.priorita // invertendo gli ordini si nota
                //console.log(`a ${a.priorita} - b${b.priorita} = ${ris}`)
            break;

            case "dipendenze":
                ris = a.dipendenze.length - b.dipendenze.length // non so se funziona
                break;
            default:
            return null
            break;
